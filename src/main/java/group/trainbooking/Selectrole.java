...
public class Selectrole extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Selectrole.class.getName());
    ...
    private void initComponents() {
        ...
        userbtn.setBackground(new java.awt.Color(0, 153, 51));
    ...
    private void adminbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminbtnActionPerformed
        ...
        Loginadmin newadminlog=new Loginadmin();
        newadminlog.setVisible(true);
        this.dispose();
